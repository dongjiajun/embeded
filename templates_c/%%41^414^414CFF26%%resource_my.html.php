<?php /* Smarty version 2.6.30, created on 2017-04-18 10:02:32
         compiled from resource_my.html */ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
image/onload1.png"></div>
		...
		<div style="width:100%; font-family:'华文楷体';font-weight:bold;color:#E5FBBB;background:#5192cc;padding-top:6px;padding-bottom:6px;"><span style="margin-left:20px">首页>我的资料</span></div>
		...
		<div style="font-family:'华文楷体';font-size:20px;margin-left:20px;margin-top:20px;">
			<div style="border:solid 1px #5192cc;width:250px;position:absolute">
				<table id="resource_my_1" border="0" width="250px" height="180px">
					<tr style="background:#094dbe;color:white"><td><a href="resource_my.html">全部资源</a></td></tr>
					<tr><td><a href="resource_my_upload.php">我的上传</a></td></tr>
					<tr><td><a href="resource_my_collect.php">我的收藏</a></td></tr>
				</table>
			</div>
			
			<div style="width:250px;font-family:'华文楷体';font-size:17px;position:absolute;top:450px;">
				<h3>下载热点</h3>
				<hr/>
...
?>
					<div class="resource_my_2"><?php echo $this->_tpl_vars['source_list'][$this->_sections['key']['index']]['source_name']; ?>
</div>
				<?php endfor; endif; ?>
			...
			<div style="width:835px;margin-left:290px;font-family:'华文楷体';font-size:17px;color:#123053">
				<table border="0" width="835px">
					<tr><td rowspan="3" width="100px"><img src="<?php echo $this->_tpl_vars['t_dir']; ?>
image/user_hade.png" width="95px"></td><td colspan="2"><?php echo $this->_tpl_vars['user_name']; ?>
</td></tr>
					<tr><td width="200px">我的积分：<?php echo $this->_tpl_vars['user_intergral']; ?>
</td><td>上传权限：2M</td></tr>
					<tr><td>上传资源数：<?php echo $this->_tpl_vars['upload_num']; ?>
个</td><td>下载资源数：<?php echo $this->_tpl_vars['user_download_num']; ?>
个</td></tr>
					<tr><td>&nbsp;&nbsp;</td></tr>
					<tr><td>&nbsp;&nbsp;</td></tr>
...
个）</span><span style="float:right"><a href="resource_my_upload.php">查看全部>></a></span></td></tr>
					<tr class="resource_my_3" style="background:#68a3d8"><td width="600px" colspan="2">标题</td><td>所需积分</td><td>下载次数</td><td>获得积分</td><td>上传日期</td></tr>
					<?php unset($this->_sections['key']);
$this->_sections['key']['name'] = 'key';
...
</div><div style="float:right;padding-right:110px;"><?php echo $this->_tpl_vars['upload_list'][$this->_sections['key']['index']]['source_price']; ?>
</div></td><td style="padding-left:40px"><?php echo $this->_tpl_vars['upload_list'][$this->_sections['key']['index']]['source_download_num']; ?>
</td><td style="padding-left:40px"><?php echo $this->_tpl_vars['upload_list'][$this->_sections['key']['index']]['get_intergral']; ?>
</td><td><?php echo $this->_tpl_vars['upload_list'][$this->_sections['key']['index']]['source_datetime']; ?>
</td></tr>
					<?php endfor; endif; ?>

					<tr style="background:#5192cc"><td colspan="6"><span style="float:left;padding:8px;">我收藏过的资源（<?php echo $this->_tpl_vars['user_collection_num']; ?>
个）</span><span style="float:right;padding:8px;"><a href="resource_my_collect.php">查看全部>></a></span></td></tr>
					<tr class="resource_my_3" style="background:#68a3d8"><td colspan="4">标题/下载积分</td><td colspan="2">下载详情</td></tr>
					<?php unset($this->_sections['key']);
$this->_sections['key']['name'] = 'key';
$this->_sections['key']['loop'] = is_array($_loop=$this->_tpl_vars['collection_list']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['key']['show'] = true;
$this->_sections['key']['max'] = $this->_sections['key']['loop'];
$this->_sections['key']['step'] = 1;
$this->_sections['key']['start'] = $this->_sections['key']['step'] > 0 ? 0 : $this->_sections['key']['loop']-1;
...
$this->_sections['key']['last']       = ($this->_sections['key']['iteration'] == $this->_sections['key']['total']);
?>
					<tr class="resource_my_3"><td colspan="4"><span style="float:left;padding:8px;"><h4><?php echo $this->_tpl_vars['collection_list'][$this->_sections['key']['index']]['source_name']; ?>
</h4></span>  <span style="float:right;padding:8px;padding-right:80px;"><?php echo $this->_tpl_vars['collection_list'][$this->_sections['key']['index']]['source_price']; ?>
</span></td><td colspan="2"> 下载量：<?php echo $this->_tpl_vars['collection_list'][$this->_sections['key']['index']]['source_download_num']; ?>
</td></tr>
					<?php endfor; endif; ?>
				</table>
			</div>
