<?php /* Smarty version 2.6.30, created on 2017-04-18 09:59:11
         compiled from resource_my_collect.html */ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
image/onload1.png"></div>
		...
		<div style="width:100%; font-family:'华文楷体';font-weight:bold;color:#E5FBBB;background:#5192cc;padding-top:6px;padding-bottom:6px;"><span style="margin-left:20px">首页&nbsp;>&nbsp;我的资料&nbsp;>&nbsp;我的收藏</span></div>
		...
		<div style="font-family:'华文楷体';font-size:20px;margin-left:20px;margin-top:20px;">
			<div style="border:solid 1px #5192cc;width:250px;position:absolute">
				<table id="resource_my_1" border="0" width="250px" height="180px">
					...
					<tr><td><a href="resource_my_collect.php"  style="color:red">我的收藏</a></td></tr>
				</table>
			</div>
			...
			<div style="width:835px;margin-left:290px;font-family:'华文楷体';font-size:17px;color:#123053">
				<table border="0" width="835px">
					...
					<tr style="background:#5192cc"><td colspan="6"><span style="float:left;padding:8px;">我收藏过的资源（<?php echo $this->_tpl_vars['collection_num']; ?>
个）</span></td></tr>
...
</h4><br/>分类：<?php echo $this->_tpl_vars['collection_list'][$this->_sections['key']['index']]['technology_name']; ?>
 </span> <span style="float:right;padding:8px;padding-right:80px;"><?php echo $this->_tpl_vars['collection_list'][$this->_sections['key']['index']]['source_price']; ?>
