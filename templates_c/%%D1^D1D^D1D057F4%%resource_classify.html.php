<?php /* Smarty version 2.6.30, created on 2017-04-18 20:13:19
         compiled from resource_classify.html */ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
image/onload1.png"></div>
		...
		<div id="resource_zong_1">
			<ul>
				...
				<li style="background:#7c9acc">分类下载</a></li>
		...
		<div style="width:100%; font-family:'华文楷体';font-weight:bold;color:#E5FBBB;background:#5192cc;padding-top:6px;padding-bottom:6px;"><span style="margin-left:20px">首页>分类下载</span></div>
		<div id="resource_classsify_zong_2">
			<table border="0" style="width:70%">
				<tr align="center">
					<th>技术分类：</th>
					<td><a href="resource_classify.php">不限</a></td>
...
"><?php echo $this->_tpl_vars['top_tech'][$this->_sections['key']['index']]['technology_name']; ?>
					...
					<?php endfor; endif; ?>
					<td><a href="resource_classify.php">其他</a></td>
				</tr>
			</table>
		</div>
