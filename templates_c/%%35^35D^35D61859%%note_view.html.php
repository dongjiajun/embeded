<?php /* Smarty version 2.6.30, created on 2017-05-04 15:12:42
         compiled from note_view.html */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
js/fun.js"></script>
    <script language="javascript">
        ...
        function pinglunfb(str)
        {

            //document.getElementById("send_id").value="32132132";
            //window.alert($_("send_id").value);
            if(str!=null)
            {
                //window.alert(str);
                document.getElementById("reply_f_id").value=str;
            }
            else{
                document.getElementById("reply_f_id").value=0;
            }
            $("#pinglunfabiaot")[0].style.display="block";
           // handle();我自己写的异步处理调用的函数。
...
</span><span style="float:right">2017-04-15&nbsp;&nbsp;&nbsp;<a href="#pinglunfabiao" onclick="pinglunfb()">评论帖子</a>&nbsp;&nbsp;&nbsp;<a href="note_view_reply_collect.php?nid=<?php echo $this->_tpl_vars['note_id']; ?>
&&col=true">收藏帖子</a></span>
                </div>
                <p>
						<pre>
...
?>
                <p>
                <div style="border:1px solid #BDCCA3;" id="<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['id']; ?>
">
                    <div style="background:#8eb7e2;padding:10px 10px;"><font size="5"><?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['reply_floor']; ?>
楼</font>&nbsp;&nbsp;<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['user_name']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;评论&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['obj_name']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="float:right;"><?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['note_reply_datetime']; ?>
&nbsp;&nbsp;&nbsp;发表&nbsp;&nbsp;&nbsp;<a href="#pinglunfabiao" onclick="pinglunfb('<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['id']; ?>
')">回复</a></span></div>
                    <div style="padding:15px">
                        <?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['note_reply_content']; ?>

                        <?php unset($this->_sections['key_son']);
$this->_sections['key_son']['name'] = 'key_son';
$this->_sections['key_son']['loop'] = is_array($_loop=$this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['key_son']['show'] = true;
$this->_sections['key_son']['max'] = $this->_sections['key_son']['loop'];
$this->_sections['key_son']['step'] = 1;
$this->_sections['key_son']['start'] = $this->_sections['key_son']['step'] > 0 ? 0 : $this->_sections['key_son']['loop']-1;
if ($this->_sections['key_son']['show']) {
    $this->_sections['key_son']['total'] = $this->_sections['key_son']['loop'];
    if ($this->_sections['key_son']['total'] == 0)
        $this->_sections['key_son']['show'] = false;
} else
    $this->_sections['key_son']['total'] = 0;
if ($this->_sections['key_son']['show']):

            for ($this->_sections['key_son']['index'] = $this->_sections['key_son']['start'], $this->_sections['key_son']['iteration'] = 1;
                 $this->_sections['key_son']['iteration'] <= $this->_sections['key_son']['total'];
                 $this->_sections['key_son']['index'] += $this->_sections['key_son']['step'], $this->_sections['key_son']['iteration']++):
$this->_sections['key_son']['rownum'] = $this->_sections['key_son']['iteration'];
$this->_sections['key_son']['index_prev'] = $this->_sections['key_son']['index'] - $this->_sections['key_son']['step'];
$this->_sections['key_son']['index_next'] = $this->_sections['key_son']['index'] + $this->_sections['key_son']['step'];
$this->_sections['key_son']['first']      = ($this->_sections['key_son']['iteration'] == 1);
$this->_sections['key_son']['last']       = ($this->_sections['key_son']['iteration'] == $this->_sections['key_son']['total']);
?>

                        <div style="border:1px solid #BDCCA3;margin-top:10px;">
                            <div style="background:#8eb7e2;padding:10px 10px;">用户：<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['user_name']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;return:&nbsp;&nbsp;<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['obj_name']; ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['note_reply_datetime']; ?>
发表&nbsp;&nbsp;&nbsp;<a href="#pinglunfabiao" onclick="pinglunfb('<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['id']; ?>
')">回复</a></div>
                            <div style="padding:10px">
                                <?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['note_reply_content']; ?>


                                <?php unset($this->_sections['key_son_son']);
$this->_sections['key_son_son']['name'] = 'key_son_son';
$this->_sections['key_son_son']['loop'] = is_array($_loop=$this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['child']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['key_son_son']['show'] = true;
$this->_sections['key_son_son']['max'] = $this->_sections['key_son_son']['loop'];
$this->_sections['key_son_son']['step'] = 1;
$this->_sections['key_son_son']['start'] = $this->_sections['key_son_son']['step'] > 0 ? 0 : $this->_sections['key_son_son']['loop']-1;
if ($this->_sections['key_son_son']['show']) {
    $this->_sections['key_son_son']['total'] = $this->_sections['key_son_son']['loop'];
    if ($this->_sections['key_son_son']['total'] == 0)
        $this->_sections['key_son_son']['show'] = false;
} else
    $this->_sections['key_son_son']['total'] = 0;
if ($this->_sections['key_son_son']['show']):

            for ($this->_sections['key_son_son']['index'] = $this->_sections['key_son_son']['start'], $this->_sections['key_son_son']['iteration'] = 1;
                 $this->_sections['key_son_son']['iteration'] <= $this->_sections['key_son_son']['total'];
                 $this->_sections['key_son_son']['index'] += $this->_sections['key_son_son']['step'], $this->_sections['key_son_son']['iteration']++):
$this->_sections['key_son_son']['rownum'] = $this->_sections['key_son_son']['iteration'];
$this->_sections['key_son_son']['index_prev'] = $this->_sections['key_son_son']['index'] - $this->_sections['key_son_son']['step'];
$this->_sections['key_son_son']['index_next'] = $this->_sections['key_son_son']['index'] + $this->_sections['key_son_son']['step'];
$this->_sections['key_son_son']['first']      = ($this->_sections['key_son_son']['iteration'] == 1);
$this->_sections['key_son_son']['last']       = ($this->_sections['key_son_son']['iteration'] == $this->_sections['key_son_son']['total']);
?>

                                <div style="border:1px solid #BDCCA3;margin-top:10px;">
                                    <div style="background:#8eb7e2;padding:10px 20px;">用户:<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['child'][$this->_sections['key_son_son']['index']]['user_name']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;return:&nbsp;&nbsp;<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['child'][$this->_sections['key_son_son']['index']]['obj_name']; ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['child'][$this->_sections['key_son_son']['index']]['note_reply_datetime']; ?>
发表&nbsp;&nbsp;&nbsp;</div>
                                    <div style="padding:10px">
                                        <?php echo $this->_tpl_vars['reply_list'][$this->_sections['key']['index']]['child'][$this->_sections['key_son']['index']]['child'][$this->_sections['key_son_son']['index']]['note_reply_content']; ?>
            ...
            <div class="preamble" id="pinglunfabiaot" style="padding-top:100px;display:none">
                ...
                <p>
                <form method="post" action="note_view_reply_collect.php?nid=<?php echo $this->_tpl_vars['note_id']; ?>
">
...
" name="reply_id"/>
                    ...
                    <!--<input type="button" value="123" onclick="handle()">-->
                   <!-- <tr style="height:40px">
                        <th>测试ajax内容：</th>
                        <td><input type="text" value="" id="my_ajax"></td>
                    </tr>-->
                    <tr style="height:40px">
                        <th>用户名：</th>
...
" style="margin-top:10px" width="230" height="230"/><figcaption style="margin-top:-8px;font-size:20px;font-family:'华文隶书';color:#2C5079"><?php echo $this->_tpl_vars['user_name']; ?>
        ...
        <center><a href="message_send.php#xiesixin"><img src="<?php echo $this->_tpl_vars['t_dir']; ?>
image/btn_sendletter.gif" style="margin-top:10px"/></a></center>
