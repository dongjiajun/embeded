<?php /* Smarty version 2.6.30, created on 2017-04-19 12:14:26
         compiled from search_main.html */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <section class="intro" id="zen-intro">
            ...
            <div class="preamble" id="zen-preamble" role="article">
                ...
                <div id="preamble_1" style="padding-left:20px;">
                    全部（<?php echo $this->_tpl_vars['note_num']; ?>
）
                </div>
                <p>
...
?>
                    <tr style="height:60px;">
                        <td><a href="note_view.php?nid=<?php echo $this->_tpl_vars['note_list'][$this->_sections['key']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['note_list'][$this->_sections['key']['index']]['note_title']; ?>
</a></td>
                        <td><?php echo $this->_tpl_vars['note_list'][$this->_sections['key']['index']]['note_datetime']; ?>
</td>
                    </tr>
                <?php endfor; endif; ?>
                </table>
            ...
            <div class="preamble" id="zen-preamble" role="article">
                <h3>查找到的资源</h3>
                <div id="preamble_1" style="padding-left:20px;">
                    全部（<?php echo $this->_tpl_vars['num_source']; ?>
）
                </div>
            ...
            <div id="resource_classsify_zong_3" style="margin-top:50px;font-family:'华文楷体'">
                <table border="0" style="width:100%">
                    ...
                    <?php unset($this->_sections['key']);
$this->_sections['key']['name'] = 'key';
$this->_sections['key']['loop'] = is_array($_loop=$this->_tpl_vars['search_source_list']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['key']['show'] = true;
$this->_sections['key']['max'] = $this->_sections['key']['loop'];
$this->_sections['key']['step'] = 1;
$this->_sections['key']['start'] = $this->_sections['key']['step'] > 0 ? 0 : $this->_sections['key']['loop']-1;
...
?>
                    <div>
                        <tr>
                            <td><h2 style="color:#051727"><a href="download.php?downname=<?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['source_addr']; ?>
&&price=<?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['source_price']; ?>
&&u_id=<?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['u_id']; ?>
"><?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['source_name']; ?>
</a></h2> </td>
                            <td><?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['source_price']; ?>
&nbsp;积分</td>
                            <td><?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['source_datetime']; ?>
</td>
                            <td>上传者：<?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['user_name']; ?>
</td>
                        </tr>
                        <tr>
                            <td>简介：<?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['source_introduce']; ?>
</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>下载量：<?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['source_download_num']; ?>
</td>
                        </tr>
                        <tr>
                            <td>标签：<?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['source_keyword']; ?>
</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>分类：<?php echo $this->_tpl_vars['search_source_list'][$this->_sections['key']['index']]['class_name']; ?>
</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
...
" style="margin-top:10px" width="230" height="230"/><figcaption style="margin-top:-8px;font-size:20px;font-family:'华文隶书';color:#2C5079"><?php echo $this->_tpl_vars['user_name']; ?>
        ...
        <table border="0" id="Blogger_1">
            <tr><td>积&nbsp;&nbsp;分：</td> <td><?php echo $this->_tpl_vars['uer_his_inter']; ?>
</td></tr>
