<?php /* Smarty version 2.6.30, created on 2017-04-18 09:58:44
         compiled from resource_new.html */ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
image/onload1.png"></div>
		...
		<div id="resource_zong_1">
			<ul>
				...
				<li style="background:#7c9acc">最新下载</li>
				<li><a href="resource_upload.php">资源上传</a></li>
				<li><a href="resource_my.php">我的资料</a></li>
			</ul>
		</div>
		<div style="width:100%; font-family:'华文楷体';font-weight:bold;color:#E5FBBB;background:#5192cc;padding-top:6px;padding-bottom:6px;"><span style="margin-left:20px">首页>最新下载</span></div>
		<div id="resource_classsify_zong_2">
			<table border="0" style="width:70%">
				<tr align="center">
					<th>技术分类：</th>
					<td><a href="resource_new.php">不限</a></td>
...
"><?php echo $this->_tpl_vars['top_tech'][$this->_sections['key']['index']]['technology_name']; ?>
					...
					<?php endfor; endif; ?>
					<td><a href="resource_new.php">其他</a></td>
				</tr>
			</table>
		</div>
